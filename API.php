  ...
  public function createIsland($player): void 
  {
    ...
    if(file_exists($worldPath))
    {
      if(!is_dir("worlds/$playerName"))
      {
        ...
        $skinPath = Server::getInstance()->getDataPath() . "plugin_data/EliteCore/model/skin/worker/Worker.png";
        $geometryPath = Server::getInstance()->getDataPath() . "plugin_data/EliteCore/model/geometry/worker/Worker.json";
  ...
  public function spawnPet($player, string $pet): bool
  {
    ...
    if($player instanceof Player)
    {
      ...
      if($petInfo !== [])
      {
        ...
        $skinPath = Server::getInstance()->getDataPath() . "plugin_data/EliteCore/" . $petInfo["Skin"];
        $geometryPath = Server::getInstance()->getDataPath() . "plugin_data/EliteCore/" . $petInfo["Geometry"];
        $bytes = $this->calculateSkinBytes($skinPath);
  ...
  public function getNextObjective($player): ?string
  {
    ...
    if($this->hasSkyIsland($playerName))
    {
      $array = array(
        ...
        "Go-In-Portal" => "Farm-Wheat",
        "Farm-Wheat" => "Mine-Iron",
        "Mine-Iron" => "Upgrade-Worker",
        "Upgrade-Worker" => "Deposit-Money",
        "Deposit-Money" => "Unlock-PotionBag",
